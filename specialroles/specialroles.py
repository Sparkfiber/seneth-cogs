...
#this is from Fox V3 cogs - trying to get this to work for my guild - do not claim any ownership of code at all

class SpecialRoles(Cog):
    """
    Custom commands
    ...
    def __init__(self, bot):
        self.bot = bot
        self.config = Config.get_conf(self, identifier=270148)
